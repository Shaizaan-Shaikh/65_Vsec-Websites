// Array to store all student records added by the user
let students = [];

// Show the marks form after valid basic details are entered
...
// Add a new student result after validating marks
function addStudent() {
  ...
  // Validate each subject mark between 0 and 100
  ...
  // Result logic: student fails if any subject is below 35
  let result = "Pass";
...
// Display all students in the records table and highlight topper
...
// Reset the form fields and return to the first form section
